#ifndef LIBCLANDRO_EXEC__NOS__C__EXEC_VARIANTS_INTERCEPT___H
#define LIBCLANDRO_EXEC__NOS__C__EXEC_VARIANTS_INTERCEPT___H
 ...
 * in `ClandroExecRuntimeBinaryTests.c`.
 *
...
#endif // LIBCLANDRO_EXEC__NOS__C__EXEC_VARIANTS_INTERCEPT___H
