---
page_ref: "@ARK_PROJECT__VARIANT@/clandro/clandro-exec-package/docs/@ARK_DOC__VERSION@/developer/contribute/index.md"
---

# clandro-exec-package Contribute Docs

<!-- @ARK_DOCS__HEADER_PLACEHOLDER@ -->

These docs are meant for you if you want to contribute to the [`clandro/clandro-exec-package`](https://github.com/cl-andro/clandro-exec-package) repository.
